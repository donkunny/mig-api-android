package com.johnjhkoo.mig_android.Listeners;
...
/*
        Log.d("GridPageFragment", "totalItemCount" + totalItemCount
                + "/ previousTotal: " + previousTotalItemCount
